...
<head>
  ...
  <title>KultureWin | Admin dashboard</title>
  <!-- plugins:css -->
...
<div id="right-sidebar" class="settings-panel">
  ...
  <script src="{{asset('assets/dash/vendors/progressbar.js/progressbar.min.js')}}"></script>
  ...
  <script src="{{asset('assets/dash/js/jquery.cookie.js')}}" type="text/javascript"></script>
  <script src="{{asset('assets/dash/js/dashboard.js')}}"></script>
  <script src="{{asset('assets/dash/js/proBanner.js')}}"></script>
