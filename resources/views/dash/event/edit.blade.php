              ...
              <div class="card">
                <div class="card-body row">
                  ...
                  <p class="card-description">
                    Edit event: <code>{{ $event->title }}</code>
                  </p>
                  <form class="forms-sample" method="POST" enctype="multipart/form-data" action="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Date" name="event_date" value="{{ $event->event_date }}"> 
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Event image <small>(Must not be above 4MB & Dim: 421px x 530px)</small></label>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control form-txt-area" name="description" placeholder="A few words about the event">{{ $event->description }}</textarea>
