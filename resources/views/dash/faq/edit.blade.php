@include('layouts.dash.header', ['pageTitle' => 'Edit FAQ'])
              ...
              <div class="card">
                <div class="card-body row">
                  ...
                  <p class="card-description">
                    Edit FAQ details below..
                  </p>
                  <form class="forms-sample" method="POST" action="">
                    {{ csrf_field() }}
                    <div class="form-group">
                      <label for="exampleInputUsername1">FAQ Question<span>*</span></label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="question" value="{{ $faq->question }}" required>
                    ...
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">FAQ Answer<span>*</span></label>
                      <textarea class="form-control form-txt-area" name="answer" required>{{ $faq->answer }}</textarea>
