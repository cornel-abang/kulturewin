                  ...
                  <form class="forms-sample" method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select-search" name="event_id">
                        ...
                        <option value="{{ $event->id }}" {{ $ticket->id === $event->id ? 'selected' : '' }}>{{ $event->title }}</option>
                        @endforeach
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputPassword1" name="price" value="{{ $ticket->price }}">
                      @if ($errors->has('price'))
                            <small class="invalid-feedback" role="alert">
                            {{ $errors->first('price') }}
                            </small>
